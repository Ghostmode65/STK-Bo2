...
local ReOpen = CreateInstance('ImageButton',{Image='rbxassetid://180219266',ImageColor3=Color3.new(1, 1, 1),ImageRectOffset=Vector2.new(0, 0),ImageRectSize=Vector2.new(0, 0),ImageTransparency=0,ScaleType=Enum.ScaleType.Stretch,SliceCenter=Rect.new(0, 0, 0, 0),AutoButtonColor=true,Modal=false,Selected=false,Style=Enum.ButtonStyle.Custom,Active=true,AnchorPoint=Vector2.new(0, 0),BackgroundColor3=Color3.new(1, 1, 1),BackgroundTransparency=0,BorderColor3=Color3.new(0.105882, 0.164706, 0.207843),BorderSizePixel=1,ClipsDescendants=false,Draggable=false,Position=UDim2.new(0.412690103, 0, 0, 0),Rotation=0,Selectable=true,Size=UDim2.new(0.190040261, 0, 0.125091836, 0),SizeConstraint=Enum.SizeConstraint.RelativeXY,Visible=false,ZIndex=1,Name='ReOpen',Parent = STKv8S})
local OpenLabel = CreateInstance('TextLabel',{Font=Enum.Font.Creepster,FontSize=Enum.FontSize.Size14,Text='Open Me',TextColor3=Color3.new(0.00392157, 0.901961, 1),TextScaled=true,TextSize=14,TextStrokeColor3=Color3.new(0.0745098, 0.211765, 1),TextStrokeTransparency=0,TextTransparency=0,TextWrapped=true,TextXAlignment=Enum.TextXAlignment.Center,TextYAlignment=Enum.TextYAlignment.Center,Active=false,AnchorPoint=Vector2.new(0, 0),BackgroundColor3=Color3.new(1, 1, 1),BackgroundTransparency=1,BorderColor3=Color3.new(0.105882, 0.164706, 0.207843),BorderSizePixel=1,ClipsDescendants=false,Draggable=false,Position=UDim2.new(0.0331119634, 0, 0.1585612, 0),Rotation=0,Selectable=false,Size=UDim2.new(0, 148, 0, 103),SizeConstraint=Enum.SizeConstraint.RelativeXY,Visible=true,ZIndex=1,Name='OpenLabel',Parent = ReOpen})
local MainFrameSet = CreateInstance('Frame',{Style=Enum.FrameStyle.Custom,Active=false,AnchorPoint=Vector2.new(0, 0),BackgroundColor3=Color3.new(1, 1, 1),BackgroundTransparency=1,BorderColor3=Color3.new(0.105882, 0.164706, 0.207843),BorderSizePixel=1,ClipsDescendants=false,Draggable=false,Position=UDim2.new(0.0578125007, 0, 0.0626006946, 0),Rotation=0,Selectable=false,Size=UDim2.new(0.897027671, 0, 0.77768594, 0),SizeConstraint=Enum.SizeConstraint.RelativeXY,Visible=true,ZIndex=1,Name = 'MainFrameSet',Parent = STKv8S})
...
local PowerButton = CreateInstance('TextButton',{Font=Enum.Font.SourceSans,FontSize=Enum.FontSize.Size14,Text='',TextColor3=Color3.new(0, 0, 0),TextScaled=false,TextSize=14,TextStrokeColor3=Color3.new(0, 0, 0),TextStrokeTransparency=1,TextTransparency=0,TextWrapped=false,TextXAlignment=Enum.TextXAlignment.Center,TextYAlignment=Enum.TextYAlignment.Center,AutoButtonColor=true,Modal=false,Selected=false,Style=Enum.ButtonStyle.Custom,Active=true,AnchorPoint=Vector2.new(0, 0),BackgroundColor3=Color3.new(1, 1, 1),BackgroundTransparency=1,BorderColor3=Color3.new(0.105882, 0.164706, 0.207843),BorderSizePixel=1,ClipsDescendants=false,Draggable=false,Position=UDim2.new(0.95764643, 0, 0.939258039, 0),Rotation=0,Selectable=true,Size=UDim2.new(0.0408954062, 0, 0.0589029826, 0),SizeConstraint=Enum.SizeConstraint.RelativeXY,Visible=true,ZIndex=1,Name='PowerButton',Parent = MainFrameSet})
local VersionNumber = CreateInstance('TextLabel',{Font=Enum.Font.Garamond,FontSize=Enum.FontSize.Size14,Text='Beta v1.2',TextColor3=Color3.new(1, 1, 1),TextScaled=true,TextSize=14,TextStrokeColor3=Color3.new(0, 0, 0),TextStrokeTransparency=1,TextTransparency=0,TextWrapped=true,TextXAlignment=Enum.TextXAlignment.Center,TextYAlignment=Enum.TextYAlignment.Center,Active=false,AnchorPoint=Vector2.new(0, 0),BackgroundColor3=Color3.new(1, 1, 1),BackgroundTransparency=1,BorderColor3=Color3.new(0.105882, 0.164706, 0.207843),BorderSizePixel=1,ClipsDescendants=false,Draggable=false,Position=UDim2.new(0.896002948, 0, 0.0122134387, 0),Rotation=0,Selectable=false,Size=UDim2.new(0.0925699994, 0, 0.0301974304, 0),SizeConstraint=Enum.SizeConstraint.RelativeXY,Visible=true,ZIndex=1,Name='VersionNumber',Parent = MainFrameSet})
local GuiControls = CreateInstance('Frame',{Style=Enum.FrameStyle.Custom,Active=false,AnchorPoint=Vector2.new(0, 0),BackgroundColor3=Color3.new(1, 1, 1),BackgroundTransparency=1,BorderColor3=Color3.new(0.105882, 0.164706, 0.207843),BorderSizePixel=1,ClipsDescendants=false,Draggable=false,Position=UDim2.new(-1.80577384e-08, 0, -0.00425079698, 0),Rotation=0,Selectable=false,Size=UDim2.new(0.516568005, 0, 0.11052072, 0),SizeConstraint=Enum.SizeConstraint.RelativeXY,Visible=true,ZIndex=1,Name = 'GuiControls',Parent = MainFrameSet})
...
Contrant = Instance.new('UIAspectRatioConstraint')
...
MenuTypeName.Parent.LocalScripts.ColdScripts.Visible = true
MenuTypeName.Parent.LocalScripts.HotScripts.Visible = true
end)

Teleports.MouseButton1Down:Connect(function() 
Turnoffmenus() task.wait()
MenuTypeName.Parent.Teleports.Visible = true
MenuTypeName.Parent.Teleports.HotScriptsScripts.Visible = true
end)
...
Notify('Script Not Found', 'Gunscripts not available at this time ')
end)

Settings.MouseButton1Down:Connect(function() 
Notify('Script Not Found', 'Settings not available at this time ')
end)
...
MenuBackupInfo.MouseButton1Down:Connect(function() 
	MenuTypeName.Parent.Teleports.ColdScripts.Visible = false
	MenuTypeName.Parent.Teleports.HotTogles.Visible = false
	MenuTypeName.Parent.LocalScripts.ColdScripts.Visible = false
	MenuTypeName.Parent.LocalScripts.HotTogles.Visible = false
...
--AntiCheat Scripts
	...
	function CheckforMod()
		...
		if v.name == "Nezza" or v.displayName == "HTsnaps" or v.name == 'GhostMode65' 
...
function getcommandcode() --Patched
	MessageGayAssPlayer2("[Menu]: Currently Patched")
end
...
-- --Esp by x_up, this is for me to remeber later
...
local Player = {}; do
	...
	function Player:SetupCharacter(Character)
		if Character:IsA 'Humanoid' and Character.name == 'Zombie' then --// todo: make function to support other games (i.e. phantom forces, strucid, etc,.)
...
--[[   
	...
	print(self.Character.parent.name)
...
for _,v in pairs(Players:GetChildren()) do task.spawn(Player.new, v) end
...
--Change to children add instead of loop! Toggable!
...
function LoadPage3()
 togglePage("Page3",
 "Nerf Killers","Disable Killers","Killer Esp",
 "NCS_B4","NCS_B5","NCS_B6",
 "NCS_B7","NCS_B8","NCS_B9",
 "NCS_B10","NCS_B11","NCS_B12",
 "NCS_B13","NCS_B14","NCS_B15",
...
if ButtonNumber == "CS_B1" then NerfKillers() end
if ButtonNumber == "CS_B2" then WheelchairKillers() end
if ButtonNumber == "CS_B3" then KillerEsp() end
if ButtonNumber == "CS_B4" then end
if ButtonNumber == "CS_B5" then end
if ButtonNumber == "CS_B6" then end
if ButtonNumber == "CS_B7" then end
...
--Link Buttons
Link1.MouseButton1Down:connect(function() setclipboard('https://www.youtube.com/channel/UCELSMWbk2NKXIerYGU3Mpwg')  end)
Link2.MouseButton1Down:connect(function() setclipboard('https://github.com/Ghostmode65/STK-Bo2/tree/master/STK-Menus') end)
Link3.MouseButton1Down:connect(function() setclipboard('https://www.youtube.com/c/CreepingpigYT') end)
--Admin Ui Tools
--DesroyMenu:
uis.InputBegan:Connect(function(input) 
