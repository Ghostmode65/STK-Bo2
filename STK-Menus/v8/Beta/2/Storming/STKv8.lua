...
for i,v in pairs(workspace["Invisible Walls"]:GetChildren()) do 

if v.Name ~= 'Trigger1' and v.Name ~= 'Trigger2' and v.Name ~= 'Trigger3' then
v:Destroy()
end end end

function RemoveAllWalls()
RemoveWalls()
workspace["Invisible Walls"].ChildAdded:Connect(function()
RemoveWalls()
end) end 
...
function LoadPage2()
 togglePage("Page2",
 "Remove Damagers","AntiAfk","Remove Barriers",
...
function LoadPage7()
 ...
 "Killer Esp","Player Esp","GunChams","NHS_4",
 "NHS_5","NHS_6","NHS_7","NHS_8",
  "DataPage7",Page7)
end
...
if ButtonNumber == "CS_B4" then game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =  workspace["Characters to kill"].Leader.Torso.CFrame end
...
if ButtonNumber == "CS_B3" then RemoveAllWalls() end
