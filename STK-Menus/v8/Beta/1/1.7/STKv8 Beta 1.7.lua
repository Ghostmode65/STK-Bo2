...
if ButtonNumber == "CS_B2" then ChangeWalkS(CS_B2,DATAPAGENUMBER,.5) game:GetService("Players").LocalPlayer.Character.Humanoid.WalkSpeed = CS_B2:GetAttribute(DATAPAGENUMBER) end
if ButtonNumber == "CS_B3" then  ChangeWalkS(CS_B3,DATAPAGENUMBER,1)  game:GetService("Players").LocalPlayer.Character.Humanoid.WalkSpeed = CS_B3:GetAttribute(DATAPAGENUMBER) end
...
if ButtonNumber == "CS_B5" then ChangeJumpP(CS_B5,DATAPAGENUMBER,.5) game:GetService("Players").LocalPlayer.Character.Humanoid.JumpPower = CS_B5:GetAttribute(DATAPAGENUMBER) end 
if ButtonNumber == "CS_B6" then ChangeJumpP(CS_B6,DATAPAGENUMBER,1)game:GetService("Players").LocalPlayer.Character.Humanoid.JumpPower = CS_B6:GetAttribute(DATAPAGENUMBER)end 
if ButtonNumber == "CS_B7" then RayGunSilence() end
if ButtonNumber == "CS_B8" then end
if ButtonNumber == "CS_B9" then end
if ButtonNumber == "CS_B10" then end
if ButtonNumber == "CS_B11" then end
