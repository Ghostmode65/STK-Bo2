...
function PackAWeapon(ToolName)
  	for i,v in pairs(game:GetService("Players").GhostMode65.Backpack:GetChildren()) do 
...
function GunEsp(ButtonN,DataPageN)
if  ButtonN:GetAttribute(DataPageN) == true then
	local esp_settings = { 
		textsize = 8,
		colour = 33, 255, 78
...
function RespawnPackAllweapons(ButtonN,DataPageN)
if ButtonN:GetAttribute(DataPageN) == true  then
PackAllWeapons()
local GayAssUser = game.Players.LocalPlayer.Name
game:GetService("Workspace")["Characters to kill"].ChildAdded:Connect(function(child)
    if child.name == GayAssUser and ButtonN:GetAttribute(DataPageN) == true then task.wait(2) PackAllWeapons()
    end end) end end 
...
function Respawn(nameoffuntion,V,ButtonN,DataPageN)
if ButtonN:GetAttribute(DataPageN) == true  then nameoffuntion(V) end
...
Respawn(nameoffuntion,V,ButtonN,DataPageN)

local GayAssUser = game.Players.LocalPlayer.Name
game:GetService("Workspace")["Characters to kill"].ChildAdded:Connect(function(child)
    if child.name == GayAssUser and ButtonN:GetAttribute(DataPageN) == true then  Respawn(nameoffuntion,V,ButtonN,DataPageN)
    end end) end  
...
function LoadPage2()
 togglePage("Page2",
 "Pack a Punch Gui","Give all Guns","Refresh Ammo",
 "InfiniteAmmo","Pack All Guns","Replaced",
 "Replaced","Pack Current Guns","Replaced",
...
function LoadPage4()
 togglePage ("Page4",
 "Pack All Weapons","Pack Current Weapon",
 ...
 "CrossBow",
 "FreezeGun","MG42","AWP",
 "M14A1","NCS_B20","NCS_B21",
 "NCS_B22","NCS_B23","NCS_B24",
 "NCS_B25", "NCS_B26","NCS_B27",
 "NCS_B28","NCS_B29","NCS_B30",
 "NCS_B31","NCS_B32","NCS_B33",

 "RePack Weapons","NHS_2","NHS_3","NHS_4",
 "NHS_5","NHS_6","NHS_7","NHS_8",
  "DataPage4",Page4)
end
...
if ButtonNumber == "CS_B5" then PackAllWeapons() end 
...
if ButtonNumber == "HS_1" then ToggleVareint(HS_1,DATAPAGENUMBER) GunChams(HS_1,DATAPAGENUMBER) end
if ButtonNumber == "HS_2" then ToggleVareint(HS_2,DATAPAGENUMBER) GunEsp(HS_2,DATAPAGENUMBER) end
if ButtonNumber == "HS_3" then ToggleVareint(HS_3,DATAPAGENUMBER) end
if ButtonNumber == "HS_4" then ToggleVareint(HS_4,DATAPAGENUMBER) end
if ButtonNumber == "HS_5" then ToggleVareint(HS_5,DATAPAGENUMBER) end
if ButtonNumber == "HS_6" then ToggleVareint(HS_6,DATAPAGENUMBER) end
...
if ButtonNumber == "CS_B1" then PackAllWeapons() end 
if ButtonNumber == "CS_B2" then  PachHeldWeapon() end
if ButtonNumber == "CS_B3" then PackAWeapon("M1014")  end 
if ButtonNumber == "CS_B4" then  PackAWeapon("M14")end
if ButtonNumber == "CS_B5" then  PackAWeapon("Desert Eagle")end 
if ButtonNumber == "CS_B6" then PackAWeapon("M4A1") end
if ButtonNumber == "CS_B7" then PackAWeapon("R870") end
if ButtonNumber == "CS_B8" then PackAWeapon("RayGun") end
if ButtonNumber == "CS_B9" then PackAWeapon("MP5k") end
if ButtonNumber == "CS_B10" then PackAWeapon("AK-47") end
if ButtonNumber == "CS_B11" then PackAWeapon("DBShotgun") end
if ButtonNumber == "CS_B12" then PackAWeapon("M16A2/M203") end
if ButtonNumber == "CS_B13" then PackAWeapon("P90") end
if ButtonNumber == "CS_B14" then PackAWeapon("SVD") end
if ButtonNumber == "CS_B15" then PackAWeapon("CrossBow") end
if ButtonNumber == "CS_B16" then PackAWeapon("FreezeGun") end
if ButtonNumber == "CS_B17" then PackAWeapon("MG42") end
if ButtonNumber == "CS_B18" then PackAWeapon("AWP") end
if ButtonNumber == "CS_B19" then PackAWeapon("M14A1") end
if ButtonNumber == "CS_B20" then PackAWeapon("AN-94") end
if ButtonNumber == "CS_B21" then PackAWeapon("G36C") end
if ButtonNumber == "CS_B22" then end
if ButtonNumber == "CS_B23" then end
if ButtonNumber == "CS_B24" then end
if ButtonNumber == "CS_B25" then end
...
if ButtonNumber == "HS_1" then ToggleVareint(HS_1,DATAPAGENUMBER) RespawnPackAllweapons(HS_1,DATAPAGENUMBER)  end
if ButtonNumber == "HS_2" then ToggleVareint(HS_2,DATAPAGENUMBER)  end
if ButtonNumber == "HS_3" then ToggleVareint(HS_3,DATAPAGENUMBER) end
if ButtonNumber == "HS_4" then ToggleVareint(HS_4,DATAPAGENUMBER) end
if ButtonNumber == "HS_5" then ToggleVareint(HS_5,DATAPAGENUMBER) end
