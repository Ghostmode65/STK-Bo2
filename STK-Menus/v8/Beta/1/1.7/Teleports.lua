...
ButtonN:SetAttribute(DataPageN, PlayerPos)
...
game:GetService("Workspace")["Characters to kill"].ChildAdded:Connect(function(child)
    if child.name == GayAssUser and ButtonN:GetAttribute(DataPageN) == true then task.wait(.3) GoToPos(ButtonN,DataPageN,OrginData) 
    end end) end
...
if ButtonNumber == "CS_B1" then   TpPlayerTo(328.48272705078125, 511.6999206542969, 398.0758361816406) end
if ButtonNumber == "CS_B2" then TpToRoom("CafeRoom") end
if ButtonNumber == "CS_B3" then TpToRoom("CartonsRoom") end
if ButtonNumber == "CS_B4" then TpPlayerTo(138.1343231201172, 333.4999084472656, 528.0997924804688) end 
...
if ButtonNumber == "CS_B12" then TpPlayerTo(237.13214111328125, 337.7999267578125, 470.4387512207031) end 
...
if ButtonNumber == "CS_B27" then TpPlayerTo(-83.90774536132812, 319.7451477050781, 461.1109924316406) end -- Rescreach
...
if ButtonNumber == "CS_B21" then TpPlayerTo(212.50833129882812, 265.62091064453125, 404.7625732421875) end 
...
if ButtonNumber == "CS_B29" then TpPlayerTo(180.4883575439453, 271.70025634765625, 205.3068389892578) end 
...
if ButtonNumber == "CS_B13" then  TpToGun("AWP") end
if ButtonNumber == "CS_B14" then  TpToGun("G36C") end
if ButtonNumber == "CS_B15" then  TpToGun("AN-94") end
...
if ButtonNumber == "CS_B1" then TpPlayerTo(277.377685546875, 323.4999084472656, 783.7623291015625)  end --Pack
...
if ButtonNumber == "CS_B5" then TpPlayerTo(354.97137451171875, 341.7999267578125, 517.811279296875) end --Broken
...
if ButtonNumber == "CS_B2" then TpPlayerTo(196.14346313476562, 343.4999084472656, 77.35603332519531) end 
if ButtonNumber == "CS_B3" then TpPlayerTo(204.40493774414062, 337.3001708984375, 290.61749267578125) end 
if ButtonNumber == "CS_B4" then TpPlayerTo(157.50050354003906, 339.4999084472656, 302.3210144042969) end 
if ButtonNumber == "CS_B5" then TpToRoom("SecretPath4") end
if ButtonNumber == "CS_B6" then TpPlayerTo(160.19378662109375, 368.4997253417969, 583.036376953125) end 
if ButtonNumber == "CS_B7" then TpToRoom("SecretPath6") end
if ButtonNumber == "CS_B8" then TpPlayerTo(135.27166748046875, 259.70025634765625, 292.7198181152344) end 
if ButtonNumber == "CS_B9" then TpToRoom("SecretPath8") end
if ButtonNumber == "CS_B10" then TpToRoom("SecretPath9") end
if ButtonNumber == "CS_B11" then TpPlayerTo(-54.3813591003418, 297.6999206542969, 131.66998291015625) end 
