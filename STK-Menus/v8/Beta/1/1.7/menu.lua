...
gui.InputBegan:Connect(function(input) 
	if ButtonN:GetAttribute(DataPageN) == true and input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
		dragging = true
		dragStart = input.Position
		startPos = gui.Position
		
		input.Changed:Connect(function()
			if input.UserInputState == Enum.UserInputState.End or ButtonN:GetAttribute(DataPageN) == false then
...
Page2.Text = "Save/Load Settings"
Page3.Text = "FPS Boost"
Page4.Text = "Graphic Improvments"
Page5.Text = "Null"
Page6.Text = "Old Menus"
Page7.Text = "Credit Info"
Page8.Text = "Ghostmode65"
--Folder Colors
...
if ButtonNumber == "CS_B7" then MoveRight() end
if ButtonNumber == "CS_B8" then end
if ButtonNumber == "CS_B9" then MoveLeft() end
...
if ButtonNumber == "CS_B1" then GetMenuPos() end 
if ButtonNumber == "CS_B2" then GetMenuSize() end
...
if ButtonNumber == "CS_B1" then  RipBoost() end 
if ButtonNumber == "CS_B2" then  ShamanBoost() end
if ButtonNumber == "CS_B3" then GhostmodesFPSBoost() end 
if ButtonNumber == "CS_B4" then Fpscounter() end
if ButtonNumber == "CS_B5" then  end 
if ButtonNumber == "CS_B6" then end
if ButtonNumber == "CS_B7" then  end
if ButtonNumber == "CS_B8" then end
...
if ButtonNumber == "CS_B1" then  RawgetsRtx() end 
if ButtonNumber == "CS_B2" then RobloxGraphicsEnhancher()  end
if ButtonNumber == "CS_B3" then  end 
if ButtonNumber == "CS_B4" then  end
if ButtonNumber == "CS_B5" then  end 
if ButtonNumber == "CS_B6" then end
...
if ButtonNumber == "CS_B1" then  loadstring(game:HttpGet('https://raw.githubusercontent.com/Ghostmode65/STK-Bo2/master/STK-Menus/v1/Original.txt'))() end 
if ButtonNumber == "CS_B2" then  loadstring(game:HttpGet('https://raw.githubusercontent.com/Ghostmode65/STK-Bo2/master/STK-Menus/v2/v2.0.txt'))() end
if ButtonNumber == "CS_B3" then  loadstring(game:HttpGet('https://raw.githubusercontent.com/Ghostmode65/STK-Bo2/master/STK-Menus/v3/v3.0.txt'))()end 
if ButtonNumber == "CS_B4" then loadstring(game:HttpGet('https://raw.githubusercontent.com/Ghostmode65/STK-Bo2/master/STK-Menus/v3/v3.2.txt'))()  end
if ButtonNumber == "CS_B5" then loadstring(game:HttpGet('https://raw.githubusercontent.com/Ghostmode65/STK-Bo2/master/STK-Menus/v3/v3.3.txt'))()  end 
if ButtonNumber == "CS_B6" then loadstring(game:HttpGet('https://raw.githubusercontent.com/Ghostmode65/STK-Bo2/master/STK-Menus/v4/STKv4.txt'))()  end
if ButtonNumber == "CS_B7" then  loadstring(game:HttpGet('https://raw.githubusercontent.com/Ghostmode65/STK-Bo2/master/STK-Menus/v4/STK4.1.txt'))() end
if ButtonNumber == "CS_B8" then loadstring(game:HttpGet('https://raw.githubusercontent.com/Ghostmode65/STK-Bo2/master/STK-Menus/v5/STKv5.txt'))() end
if ButtonNumber == "CS_B9" then loadstring(game:HttpGet('https://raw.githubusercontent.com/Ghostmode65/STK-Bo2/master/STK-Menus/v6/STKv6.txt'))() 
game:GetService("CoreGui").SSB.Main.Position = UDim2.new(0, 1500, 0, -200) end
if ButtonNumber == "CS_B10" then loadstring(game:HttpGet('https://github.com/Ghostmode65/STK-Bo2/blob/master/STK-Menus/v7/STKv7-Engine_Edition_LoadString.txt'))() end
if ButtonNumber == "CS_B11" then Removeoldmenus() end
if ButtonNumber == "CS_B12" then end
if ButtonNumber == "CS_B13" then  end
if ButtonNumber == "CS_B14" then end
if ButtonNumber == "CS_B15" then end
