...
for i,v in pairs(workspace.workspace.AREA51.RadioactiveArea:GetChildren()) do 
if v.name == 'Entrance' then  v:Destroy() end end  end 

function RemoveDamgeScripts() 
for i,v in pairs(workspace.workspace.AREA51:GetDescendants()) do 
if v.name == 'Damage' then  v:Destroy() end end  end 
