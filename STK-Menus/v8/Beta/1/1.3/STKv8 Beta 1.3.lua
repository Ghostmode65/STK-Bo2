...
AddUILimit(LocalSetOne.Parent,1.818)
AddUILimit(LocalSetOne.Parent.Parent,1.576)
...
function Turnoffmenus()
	LocalSetOne.Parent.Settings.Visible = false
LocalSetOne.Parent.Guns.Visible = false
	LocalSetOne.Parent.Teleports.Visible = false
	LocalSetOne.Parent.LocalScripts.Visible = false
end

LocalScripts.MouseButton1Down:Connect(function() 
Turnoffmenus() task.wait()
LocalSetOne.Parent.LocalScripts.Visible = true
end)
...
Turnoffmenus() task.wait()
LocalSetOne.Parent.Guns.Visible = true
end)
...
function killerEsp(ButtonN,DataPageN)
...
if ButtonN:GetAttribute(DataPageN) == true then
	for _,t in pairs(game:GetService("Workspace").Killers:GetDescendants()) do 
		...
		for _,t in pairs(game:GetService("Workspace").Killers:GetDescendants()) do 
			if t:IsA'Tool' then t:destroy() end end end end) end


function WheelchairKillers(ButtonN,DataPageN) 
game:GetService("Workspace").Killers.ChildAddedAdded:Connect(function()
	if ButtonN:GetAttribute(DataPageN) == true then
...
if ButtonNumber == "HS_1" then ToggleVareint(HS_1,DATAPAGENUMBER) killerEsp(HS_1,DATAPAGENUMBER) end
...
if ButtonNumber == "HS_5" then ToggleVareint(HS_5,DATAPAGENUMBER) PlayerEsp(HS_5,DATAPAGENUMBER) end
if ButtonNumber == "HS_6" then ToggleVareint(HS_6,DATAPAGENUMBER) end
if ButtonNumber == "HS_7" then ToggleVareint(HS_7,DATAPAGENUMBER) end
if ButtonNumber == "HS_8" then ToggleVareint(HS_8,DATAPAGENUMBER) end
LoadColorState(DATAPAGENUMBER)
