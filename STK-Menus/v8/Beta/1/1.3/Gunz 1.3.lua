...
AddUILimit(LocalSetThree,1.531)
...
LocalSetThree.Parent.Settings.Visible = true
LocalSetThree.Visible = false
end)

GuiBack.MouseButton1Down:Connect(function() 
LocalSetThree.Parent.Teleports.Visible = true
LocalSetThree.Visible = false
end)
...
LocalSetThree:SetAttribute("LoadedPage",PageName)
CS_B1.Text = NCS_B1
CS_B2.Text = NCS_B2
CS_B3.Text = NCS_B3
CS_B4.Text = NCS_B4
...
if LocalSetThree:GetAttribute("LoadedPage") == "Page1" then 
 SelectedPage1(ButtonNumber)
end
if LocalSetThree:GetAttribute("LoadedPage") == "Page2" then 
SelectedPage2(ButtonNumber)
end
if LocalSetThree:GetAttribute("LoadedPage") == "Page3" then 
SelectedPage3(ButtonNumber)
end
if LocalSetThree:GetAttribute("LoadedPage") == "Page4" then 
SelectedPage4(ButtonNumber)
end
if LocalSetThree:GetAttribute("LoadedPage") == "Page5" then 
SelectedPage5(ButtonNumber)
end
if LocalSetThree:GetAttribute("LoadedPage") == "Page6" then 
SelectedPage6(ButtonNumber)
end
if LocalSetThree:GetAttribute("LoadedPage") == "Page7" then 
SelectedPage7(ButtonNumber)
end
if LocalSetThree:GetAttribute("LoadedPage") == "Page8" then 
...
function PageChange(PageNumber,ToPage,togglepagehere)
  if LocalSetThree:GetAttribute("LoadedPage") == PageNumber  then LocalSetThree:SetAttribute("LoadedPage",ToPage) togglepagehere()
  end end
...
function ChangePageDataNumber(SelectedPage)
    LocalSetThree:SetAttribute("LoadedPage",SelectedPage)
end
