...
LocalSetTwo.Parent.LocalScripts.Visible = true
LocalSetTwo.Visible = false
end)

GuiNext.MouseButton1Down:Connect(function() 
LocalSetTwo.Parent.Guns.Visible = true
LocalSetTwo.Visible = false
end)
...
function TptoPosOnlowhp(ButtonN,DataPageN,OrginData) -- Test
  game.Players.LocalPlayer.Character.Humanoid:getPropertyChangedSignal("Health"):connect(function()	
if ButtonN:GetAttribute(DataPageN) == true and game.Players.LocalPlayer.Character.Humanoid.Health < 20 then 
...
LocalSetTwo:SetAttribute("LoadedPage",PageName)
CS_B1.Text = NCS_B1
CS_B2.Text = NCS_B2
CS_B3.Text = NCS_B3
CS_B4.Text = NCS_B4
...
if LocalSetTwo:GetAttribute("LoadedPage") == "Page1" then 
 SelectedPage1(ButtonNumber)
end
if LocalSetTwo:GetAttribute("LoadedPage") == "Page2" then 
SelectedPage2(ButtonNumber)
end
if LocalSetTwo:GetAttribute("LoadedPage") == "Page3" then 
SelectedPage3(ButtonNumber)
end
if LocalSetTwo:GetAttribute("LoadedPage") == "Page4" then 
SelectedPage4(ButtonNumber)
end
if LocalSetTwo:GetAttribute("LoadedPage") == "Page5" then 
SelectedPage5(ButtonNumber)
end
if LocalSetTwo:GetAttribute("LoadedPage") == "Page6" then 
SelectedPage6(ButtonNumber)
end
if LocalSetTwo:GetAttribute("LoadedPage") == "Page7" then 
SelectedPage7(ButtonNumber)
end
if LocalSetTwo:GetAttribute("LoadedPage") == "Page8" then 
...
function PageChange(PageNumber,ToPage,togglepagehere)
  if LocalSetTwo:GetAttribute("LoadedPage") == PageNumber  then LocalSetTwo:SetAttribute("LoadedPage",ToPage) togglepagehere()
  end end
...
function ChangePageDataNumber(SelectedPage)
    LocalSetTwo:SetAttribute("LoadedPage",SelectedPage)
end
